...
f.call = function() {
  ...
  var w = null, w = function(w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb, Bb, Wb, uc, Vc, Pd, xe) {
    switch(arguments.length) {
      case 1:
      ...
      case 18:
        return e.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb, Bb, Wb);
      case 19:
        return d.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb, Bb, Wb, uc);
      case 20:
        return c.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb, Bb, Wb, uc, Vc);
      case 21:
        return b.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb, Bb, Wb, uc, Vc, Pd);
      case 22:
        return a.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb, Bb, Wb, uc, Vc, Pd, xe);
    }
    throw Error("Invalid arity: " + arguments.length);
  };
  w.b = eb;
...
f.Ya = function(a, b) {
  if (y(this.Na)) {
    if (null != b ? b.i & 2048 || b.Ab || (b.i ? 0 : z(La, b)) : z(La, b)) {
...
f.ga = function(a, b, c, d, e) {
  ...
  if (0 === (this.G & g)) {
    ...
    e.la = !0;
    return new Od(null, this.G | g, a);
  }
  var l = this.a[2 * h], g = this.a[2 * h + 1];
  if (null == l) {
    return k = g.ga(a + 5, b, c, d, e), k === g ? this : new Od(null, this.G, Ld(this.a, 2 * h + 1, k));
  }
  if (Kd(c, l)) {
    return d === g ? this : new Od(null, this.G, Ld(this.a, 2 * h + 1, d));
  }
  e.la = !0;
  e = this.G;
  k = this.a;
  ...
  d[c] = null;
  d[h] = a;
  return new Od(null, e, d);
};
f.Da = function() {
  return new Nd(this.a, 0, null, null);
};
var Sd = new Od(null, 0, []);
function Xd(a, b, c) {
  this.a = a;
  this.j = b;
  this.ia = c;
...
f.ha = function(a, b, c, d, e, g) {
  ...
  return (new Od(a, 1 << (this.Ea >>> b & 31), [null, this, null, null])).ha(a, b, c, d, e, g);
};
f.ga = function(a, b, c, d, e) {
  return b === this.Ea ? (a = $d(this.a, this.h, c), -1 === a ? (a = 2 * this.h, b = Array(a + 2), oc(this.a, 0, b, 0, a), b[a] = c, b[a + 1] = d, e.la = !0, new ae(null, this.Ea, this.h + 1, b)) : Q.c(this.a[a], d) ? this : new ae(null, this.Ea, this.h, Ld(this.a, a + 1, d))) : (new Od(null, 1 << (this.Ea >>> a & 31), [null, this])).ga(a, b, c, d, e);
};
f.Da = function() {
  return new Nd(this.a, 0, null, null);
};
