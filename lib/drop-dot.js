...
f.m = function(a, b) {
  return Yb.c ? Yb.c(this, b) : Yb.call(null, this, b);
};
f.S = function(a, b) {
...
function dc(a, b) {
  ...
  throw Error([D("nth not supported on this type "), D(wa(null == a ? null : a.constructor))].join(""));
}
function Gb(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
...
f.call = function() {
  ...
  var w = null, w = function(w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb, Bb, Xb, wc, Xc, Rd, Ae) {
    switch(arguments.length) {
      case 1:
      ...
      case 13:
        return m.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma);
      case 14:
        return l.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua);
      case 15:
        return k.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db);
      case 16:
        return h.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb);
      case 17:
        return g.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb, Bb);
      case 18:
        return e.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb, Bb, Xb);
      case 19:
        return d.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb, Bb, Xb, wc);
      case 20:
        return c.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb, Bb, Xb, wc, Xc);
      case 21:
        return b.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb, Bb, Xb, wc, Xc, Rd);
      case 22:
        return a.call(this, w, T, V, X, aa, da, ha, ja, na, ra, va, Ea, Ma, Ua, db, qb, Bb, Xb, wc, Xc, Rd, Ae);
    }
    throw Error("Invalid arity: " + arguments.length);
  };
  w.b = eb;
...
var cd = function cd(b, c, d, e) {
  var g = new Zc(d.w, F(d.a)), h = b.h - 1 >>> c & 31;
...
f.M = function(a, b) {
  ...
  d ? (d = $c(null), d.a[0] = this.root, e = bd(null, this.shift, new Zc(null, this.V)), d.a[1] = e) : d = cd(this, this.shift, this.root, new Zc(null, this.V));
...
var Tc = new Zc(null, [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null]), bc = new W(null, 0, 5, Tc, [], Nb);
...
f.Ya = function(a, b) {
  if (this.root.w) {
    if (32 > this.h - ad(this)) {
      ...
      var c = new Zc(this.root.w, this.V), d = [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null];
      d[0] = b;
      this.V = d;
      if (this.h >>> 5 > 1 << this.shift) {
        ...
        this.root = new Zc(this.root.w, d);
        this.shift = e;
      } else {
...
f.Ja = function(a) {
  ...
  var b = xc(this.G), c = Array(0 > b ? 4 : 2 * (b + 1));
  pc(this.a, 0, c, 0, 2 * b);
...
f.Ka = function(a, b, c, d) {
  ...
  var g = xc(this.G & e - 1), e = this.a[2 * g], g = this.a[2 * g + 1];
  return null == e ? g.Ka(a + 5, b, c, d) : Ld(c, e) ? g : d;
};
f.ha = function(a, b, c, d, e, g) {
  var h = 1 << (c >>> b & 31), k = xc(this.G & h - 1);
  if (0 === (this.G & h)) {
    var l = xc(this.G);
...
f.ga = function(a, b, c, d, e) {
  var g = 1 << (b >>> a & 31), h = xc(this.G & g - 1);
  if (0 === (this.G & g)) {
    var k = xc(this.G);
    if (16 <= k) {
...
var ye = function ye(b) {
  ...
  if (null == b ? 0 : null != b ? b.i & 8 || b.Mb || (b.i ? 0 : z(Fa, b)) : z(Fa, b)) {
    c = [];
    b = M(Y.c(ye, b));
    d = null;
    for (g = e = 0;;) {
...
Je.A = function(a) {
  ...
  (ta(Ie.pathExists("~/Dropbox")) || ta(Q.c(Yc.platform, "linux") || Q.c(Yc.platform, "darwin")) || ta(Ie.pathExists("~/Dropbox/.drop-dot"))) && ue($b(["Failure.."], 0));
